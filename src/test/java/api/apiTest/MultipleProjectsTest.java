...
public class MultipleProjectsTest {
    ...
    String[] projectsContent = {
            "Project Marcos 1 " + LocalTime.now().format(DateTimeFormatter.ofPattern("HHmmss")),
            "Project Marcos 2 " + LocalTime.now().format(DateTimeFormatter.ofPattern("HHmmss")),
            "Project Marcos 3 " + LocalTime.now().format(DateTimeFormatter.ofPattern("HHmmss")),
            "Project Marcos 4 " + LocalTime.now().format(DateTimeFormatter.ofPattern("HHmmss"))
